 ...
 */
var dispatchHook = (element, action) => element.dispatchEvent(action);
 ...
 */
var namespacedProp = (property) => `easyToggleState_${property}`;
 ...
 */
var retrieveGroupActiveElement = element => {
 ...
 * @returns {undefined}
 */
var toggleClassList = (element, list) => list.forEach(listItem => {
...
export default main;
export { isActive, unbind, unbindAll };
